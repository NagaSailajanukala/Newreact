      ...
      <div class="container">
        ...
        <div id="item">
            ...
            <div class="inner-item">
                ...
                <input type="email" id="email" name="email" placeholder="ex:email@yahoo.com" required/>
            </div>
        </div>
        <div id="item">
            <div class="inner-item">
            ...
            <div class="inner-item">
                <label for="yes">yes</label><input type="radio" name="active" id="yes" value="yes"/>
                <label for="No">No</label><input type="radio" name="active" id="No" value="No"/></div>
        </div>
        <div id="item">
            <div class="inner-item">
        ...
        <div id="item">
                   <label for="Streetline1">Address: Street Line1</label>
                     <input type="text"
                        id="street-Address"
                        name="Streetline1" placeholder="Street Line1" required/>
        </div>
        <div id="item">
                   <label for="Streetline1">Street Line2</label>
                     <input type="text"
                        id="street-Address"
                        name="Streetline2" placeholder="Street Line2" required/>
        </div>
        {/* <div id="item">
            <label for="Streetline1">Street Line2</label>
                 <input type="text"
